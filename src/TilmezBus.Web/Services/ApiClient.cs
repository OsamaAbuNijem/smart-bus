...
public class ApiClient : IApiClient
{
    ...
    public Task<List<TilmezBus.Application.Features.Trips.Queries.GetTripStudents.TripStudentDto>?> GetTripStudentsAsync(Guid tripId)
        => GetAsync<List<TilmezBus.Application.Features.Trips.Queries.GetTripStudents.TripStudentDto>>($"api/v1/trips/{tripId}/students");
