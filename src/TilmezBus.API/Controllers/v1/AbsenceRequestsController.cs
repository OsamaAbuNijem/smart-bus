...
using TilmezBus.Application.Features.AbsenceRequests.Commands.CancelAbsenceRequest;
using TilmezBus.Application.Features.AbsenceRequests.Commands.ForceCancelAbsenceRequest;
using TilmezBus.Application.Features.AbsenceRequests.Commands.SubmitAbsenceRequest;
using TilmezBus.Application.Features.AbsenceRequests.Commands.UpdateAbsenceRequestStatus;
using TilmezBus.Application.Features.AbsenceRequests.Queries.GetAbsenceRequestsByStudent;
using TilmezBus.Application.Features.AbsenceRequests.Queries.GetPendingAbsenceRequests;
...
public record UpdateAbsenceStatusRequest(TilmezBus.Domain.Enums.AbsenceRequestStatus Status);
