...
mixin _$StudentInfoDto {
 ...
 String get id; String get fullName; String? get fullNameEn; String get nationalNumber; String get grade;@JsonKey(name: 'class') String? get className; DateTime? get dateOfBirth; String? get schoolName; String get homeAddress; String? get homeArea; String? get homeStreet; String? get notes; String? get routeName; String? get pickupStopName; List<String> get allergies; StudentContactDto? get parent;
...
@useResult
$Res call({
 String id, String fullName, String? fullNameEn, String nationalNumber, String grade,@JsonKey(name: 'class') String? className, DateTime? dateOfBirth, String? schoolName, String homeAddress, String? homeArea, String? homeStreet, String? notes, String? routeName, String? pickupStopName, List<String> allergies, StudentContactDto? parent
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fullName,  String? fullNameEn,  String nationalNumber,  String grade, @JsonKey(name: 'class')  String? className,  DateTime? dateOfBirth,  String? schoolName,  String homeAddress,  String? homeArea,  String? homeStreet,  String? notes,  String? routeName,  String? pickupStopName,  List<String> allergies,  StudentContactDto? parent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StudentInfoDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fullName,  String? fullNameEn,  String nationalNumber,  String grade, @JsonKey(name: 'class')  String? className,  DateTime? dateOfBirth,  String? schoolName,  String homeAddress,  String? homeArea,  String? homeStreet,  String? notes,  String? routeName,  String? pickupStopName,  List<String> allergies,  StudentContactDto? parent)  $default,) {final _that = this;
switch (_that) {
case _StudentInfoDto():
return $default(_that.id,_that.fullName,_that.fullNameEn,_that.nationalNumber,_that.grade,_that.className,_that.dateOfBirth,_that.schoolName,_that.homeAddress,_that.homeArea,_that.homeStreet,_that.notes,_that.routeName,_that.pickupStopName,_that.allergies,_that.parent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fullName,  String? fullNameEn,  String nationalNumber,  String grade, @JsonKey(name: 'class')  String? className,  DateTime? dateOfBirth,  String? schoolName,  String homeAddress,  String? homeArea,  String? homeStreet,  String? notes,  String? routeName,  String? pickupStopName,  List<String> allergies,  StudentContactDto? parent)?  $default,) {final _that = this;
switch (_that) {
case _StudentInfoDto() when $default != null:
return $default(_that.id,_that.fullName,_that.fullNameEn,_that.nationalNumber,_that.grade,_that.className,_that.dateOfBirth,_that.schoolName,_that.homeAddress,_that.homeArea,_that.homeStreet,_that.notes,_that.routeName,_that.pickupStopName,_that.allergies,_that.parent);case _:
  return null;
...
class _StudentInfoDto implements StudentInfoDto {
  const _StudentInfoDto({required this.id, required this.fullName, this.fullNameEn, required this.nationalNumber, required this.grade, @JsonKey(name: 'class') this.className, this.dateOfBirth, this.schoolName, required this.homeAddress, this.homeArea, this.homeStreet, this.notes, this.routeName, this.pickupStopName, final  List<String> allergies = const <String>[], this.parent}): _allergies = allergies;
