...
using SmartBus.Application.Features.StudentTrips.Commands.UpdateBoardingStatus;
using SmartBus.Application.Features.StudentTrips.Queries.GetStudentsByTrip;
