...
class _StudentInfoDto implements StudentInfoDto {
  const _StudentInfoDto({required this.id, required this.fullName, this.fullNameEn, required this.nationalNumber, required this.grade, @JsonKey(name: 'class') this.className, this.dateOfBirth, this.schoolName, this.schoolAddress, required this.homeAddress, this.homeArea, this.homeStreet, this.notes, this.routeName, this.pickupStopName, final  List<String> allergies = const <String>[], this.parent}): _allergies = allergies;
