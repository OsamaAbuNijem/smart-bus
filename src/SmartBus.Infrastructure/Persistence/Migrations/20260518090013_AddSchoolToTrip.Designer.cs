...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.SubscriptionPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.SubscriptionStudent", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.SuperAdminBroadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.SubscriptionPayment", b =>
                {
                    b.HasOne("SmartBus.Domain.Entities.Subscription", "Subscription")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("SmartBus.Domain.Entities.Trip", b =>
                {
                    b.HasOne("SmartBus.Domain.Entities.Driver", "Assistant")
                        .WithMany()
